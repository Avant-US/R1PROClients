...
def weighted_average_joint_action(actions, weights):
    ...
    avg_action[JointAction.torso_dims] = weighted_average_linear(actions[:, JointAction.torso_dims], weights)
    avg_action[JointAction.chassis_dims] = weighted_average_linear(actions[:, JointAction.chassis_dims], weights)
    return avg_action
